...
description: Move recent Claude Code session files for this project from one config directory to another (e.g. ~/.claude → ~/.claude-work) after a wrong-account mishap
---
...
`/` with `-` and prefixing with `-`. Example: `/Users/john/code/my-resume`
→ `-Users-john-code-my-resume`.
